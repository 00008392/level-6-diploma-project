...
namespace Booking.Domain.Logic.IntegrationEvents.Events.Core
{
   public abstract class BaseAccommodationIntegrationEvent: IntegrationEvent
    {
        ...
        protected BaseAccommodationIntegrationEvent(string title, long ownerId, 
             string address, 
            string contactNumber, int? roomsNo, int? bathroomsNo, 
            int? bedsNo, int maxGuestsNo, int? squareMeters, 
