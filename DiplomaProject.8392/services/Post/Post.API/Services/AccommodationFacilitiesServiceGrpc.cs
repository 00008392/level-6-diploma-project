...
{
    public class AccommodationSpecificitiesServiceGrpc: AccommodationSpecificities.AccommodationSpecificitiesBase
    {
        public AccommodationSpecificitiesServiceGrpc(IAccommodationItemsStrategy<AccommodationSpecificity, Specificity> strategy)
            :base(strategy)
        {
